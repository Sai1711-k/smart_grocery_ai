...
const exactProducts = [
    ...
    // Bakery (10 unique)
    { name: 'White Bread', category: 'Bakery', price: 40, image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=80' }, // Standard white loaf
    { name: 'Brown Bread', category: 'Bakery', price: 50, image: 'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=400&q=80' }, // Darker loaf
    { name: 'Multigrain Bread', category: 'Bakery', price: 60, image: 'https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=400&q=80' }, // Seeded loaf
    { name: 'Butter Croissant', category: 'Bakery', price: 80, image: 'https://images.unsplash.com/photo-1555507036-ab1f40ce88cb?w=400&q=80' },
    { name: 'Chocolate Muffin', category: 'Bakery', price: 60, image: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=400&q=80' }, // Chocolate muffin
    ...
    // Oils (6 unique)
    { name: 'Sunflower Oil 1L', category: 'Oils', price: 140, image: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&q=80' }, // Oil pour
    { name: 'Olive Oil 500ml', category: 'Oils', price: 450, image: 'https://images.unsplash.com/photo-1474722883778-792e7990302f?w=400&q=80' }, // Olive branch and oil
    { name: 'Mustard Oil 1L', category: 'Oils', price: 160, image: 'https://images.unsplash.com/photo-1620706857370-e1b9770e8bb1?w=400&q=80' }, // Yellow oil bottle
    { name: 'Coconut Oil 500ml', category: 'Oils', price: 200, image: 'https://images.unsplash.com/photo-1611078502570-0720b00511de?w=400&q=80' }, // Coconut jar
    { name: 'Groundnut Oil 1L', category: 'Oils', price: 180, image: 'https://images.unsplash.com/photo-1597843058814-5d5d83637651?w=400&q=80' }, // Different oil
    { name: 'Sesame Oil 500ml', category: 'Oils', price: 250, image: 'https://images.unsplash.com/photo-1605330366113-176c5bfae6f4?w=400&q=80' }, // Different oil setup
    // Grains (8 unique)
    ...
    { name: 'Sona Masoori Rice 5kg', category: 'Grains', price: 300, image: 'https://images.unsplash.com/photo-1536304929831-ee1ca9d44906?w=400&q=80' }, // Sack of rice
    ...
    { name: 'Toor Dal 1kg', category: 'Grains', price: 160, image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400&q=80' }, // Yellow split peas
    { name: 'Moong Dal 1kg', category: 'Grains', price: 130, image: 'https://images.unsplash.com/photo-1616421319766-3d237b67b1b3?w=400&q=80' }, // Green dal
    { name: 'Chana Dal 1kg', category: 'Grains', price: 90, image: 'https://images.unsplash.com/photo-1515543904379-3d757afe72e3?w=400&q=80' }, // Lentils
    ...
    { name: 'Quinoa 500g', category: 'Grains', price: 250, image: 'https://images.unsplash.com/photo-1580087433276-857e4e083c66?w=400&q=80' },
];
async function reseed() {
    console.log('Fetching providers...');
    let { data: providers, error: provErr } = await supabaseAdmin.from('providers').select('id');
    if (provErr || !providers?.length) {
        console.log('No providers found! Creating a default provider...');
        const { data: newProvider, error: createProvErr } = await supabaseAdmin
            .from('providers')
            .insert([{
                name: 'Fresh Grocery Plus',
                description: 'Main supplier for all grocery items',
                contact_email: 'supplier@grocery.com',
                contact_phone: '+1234567890'
            }])
            .select('id')
            .single();
        if (createProvErr) {
            console.error('Failed to create provider:', createProvErr.message);
            return;
        }
    ...
    console.log(`Inserting ${exactProducts.length} unique products...`);
    let count = 0;
    ...
    console.log(`Successfully reseeded database with ${count} totally unique products!`);
}
reseed();
